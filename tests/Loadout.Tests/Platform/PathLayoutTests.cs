...
public sealed class PathLayoutTests
{
    ...
    public void Windows_separates_roaming_configuration_from_local_state()
    {
        ...
        paths.Config.Should().Be(@"C:\Users\test\AppData\Roaming\Loadout");
        ...
        paths.State.Should().Be(@"C:\Users\test\AppData\Local\Loadout");
    ...
    public void Linux_honours_each_xdg_root_independently()
    {
        ...
        // single base.
        paths.Config.Should().Be(Path.Combine("/custom/config", "loadout"));
        paths.State.Should().Be(Path.Combine("/custom/data", "loadout"));
        paths.Cache.Should().Be(Path.Combine("/custom/cache", "loadout"));
        paths.Logs.Should().Be(Path.Combine("/custom/state", "loadout", "logs"));
    }
    ...
    public void Linux_falls_back_to_the_xdg_defaults_when_unset()
    {
        ...
        paths.Config.Should().Be(Path.Combine("/home/test", ".config", "loadout"));
        paths.State.Should().Be(
            Path.Combine("/home/test", ".local", "share", "loadout"));
    }
    ...
    public void MacOS_uses_native_library_conventions_by_default()
    {
        ...
        paths.Config.Should().Be(
            Path.Combine("/Users/test", "Library", "Application Support", "Loadout"));

        paths.Logs.Should().Be(
            Path.Combine("/Users/test", "Library", "Logs", "Loadout"));
    ...
    public void MacOS_is_not_treated_as_linux()
    {
        ...
        paths.Config.Should().NotContain("loadout");
    }
    ...
    public void MacOS_switches_to_xdg_only_on_explicit_opt_in()
    {
        ...
        paths.Config.Should().Be(Path.Combine("/Users/test/.config", "loadout"));
    }
